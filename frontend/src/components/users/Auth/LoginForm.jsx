...
const EyeOffIcon = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3.98 8.223A10.477 10.477 0 002.25 12c1.25 4.5 5.25 7.5 9.75 7.5 1.956 0 3.693-.5 5.18-1.257M6.53 6.53A10.45 10.45 0 0112 4.5c4.5 0 8.5 3 9.75 7.5a17.896 17.896 0 01-3.362 4.412M15 12a3 3 0 01-3 3m0 0a3 3 0 01-3-3m3 3L3 3"
    />
  </svg>
);
