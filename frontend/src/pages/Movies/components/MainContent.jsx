...
const TechnicalSection = ({ movie }) => (
  <div className="space-y-6 text-white">
    <h3 className="mb-4 text-2xl font-bold">Thông tin kỹ thuật</h3>

    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
      {movie.runtime && (
        <div className="rounded-lg bg-gray-800/50 p-4">
          <h4 className="mb-2 font-semibold text-gray-300">Thời lượng</h4>
      ...
      {movie.release_date && (
        <div className="rounded-lg bg-gray-800/50 p-4">
          <h4 className="mb-2 font-semibold text-gray-300">Ngày phát hành</h4>
      ...
      {movie.adult !== undefined && (
        <div className="rounded-lg bg-gray-800/50 p-4">
          <h4 className="mb-2 font-semibold text-gray-300">Giới hạn tuổi</h4>
      ...
      {movie.status && (
        <div className="rounded-lg bg-gray-800/50 p-4">
          <h4 className="mb-2 font-semibold text-gray-300">Trạng thái sản xuất</h4>
    ...
    {(movie.cached_imdb_rating || movie.cached_tmdb_rating) && (
      <div>
        <h4 className="mb-4 text-xl font-semibold">Đánh giá từ các nguồn</h4>
...
const MediaSection = ({ movie }) => (
  <div className="space-y-6 text-white">
    ...
    {movie.images ? (
        ...
        {(!movie.images.posters || movie.images.posters.length === 0) &&
          ...
          (!movie.images.screenshots || movie.images.screenshots.length === 0) && (
            <div className="py-12 text-center">
              <h4 className="mb-2 text-xl font-semibold text-gray-400">Không có hình ảnh</h4>
      ...
      <div className="py-12 text-center">
        <h4 className="mb-2 text-xl font-semibold text-gray-400">Đang tải hình ảnh...</h4>
...
const RecommendTabSection = ({ similarMovies }) => (
  <div className="space-y-6 text-white">
    {similarMovies && similarMovies.length > 0 ? (
      <div>
        <h3 className="mb-4 text-2xl font-bold">Phim tương tự</h3>
      ...
      <div className="py-12 text-center">
        <h3 className="mb-2 text-xl font-semibold text-gray-400">Không có phim tương tự</h3>
