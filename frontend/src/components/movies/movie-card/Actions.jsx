    ...
    <div className="flex items-center gap-2">
      ...
      {!onlyBookmark && (
        <button
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded bg-red-600 px-4 py-2 text-xs font-semibold text-white shadow transition hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
